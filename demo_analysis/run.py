...
def group_study_first_shot_accuracy():
    demo_path_case = r"X:\code\CSGO_AI\demo_analysis\demo\demos_extracted\de_dust2\g2-vs-vitality-m1-dust2.dem"
    processor = Aim_Analysis_Group(demo_path_case)
    
    # processor.first_shot_accuracy()
    load_path = 'demo_analysis/intermediate_data/accuracy_dict_sample.pickle'
    processor.first_shot_acc_freq_plot(load_path=load_path)
...
def flash_distribution():
    demo_path_case = r"X:\code\CSGO_AI\demo_analysis\demo\demos_extracted\de_dust2\g2-vs-vitality-m1-dust2.dem"
    processor = Utility_Analysis(demo_path_case)
    processor.flash_distribution_on_map()
    
def smoke_distribution():
    demo_path_case = r"X:\code\CSGO_AI\demo_analysis\demo\demos_extracted\de_dust2\g2-vs-vitality-m1-dust2.dem"
    processor = Utility_Analysis(demo_path_case)
    processor.smoke_distribution_on_map()

if __name__ == '__main__':
    # print(round_1_data.head())

    # visualize_player_fire_data()
    # anime_player_movements(16)
