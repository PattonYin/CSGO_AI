...
offset_height_top = 55 
offset_height_bottom = 55 
offset_sides = 20 # ignore this many pixels on sides, 


def check_index(round_num=0):
    '''
    This function is used to check the index of the image saved
    '''
    os.makedirs(f'data/video/{round_num}', exist_ok=True)
    last_idx = os.listdir(f'data/video/{round_num}')[-1]
    return last_idx
